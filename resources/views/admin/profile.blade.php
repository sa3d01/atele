                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="white-box">
                                    ...
                                    <input name="image" type="file" id="input-file-now-custom-1" class="dropify" @if($row->image) data-default-file="{{$row->image}}" @else data-default-file="{{asset('images/user/admin.png')}}"  @endif/>
                                    @if ($errors->has('image'))
